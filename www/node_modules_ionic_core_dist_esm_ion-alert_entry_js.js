...
const Alert = class {
   ...
   */
  present() {
    return (0,_overlays_58fa8e4d_js__WEBPACK_IMPORTED_MODULE_4__.d)(this, 'alertEnter', iosEnterAnimation, mdEnterAnimation);
  }
  /**
   ...
   */
  dismiss(data, role) {
    return (0,_overlays_58fa8e4d_js__WEBPACK_IMPORTED_MODULE_4__.f)(this, data, role, 'alertLeave', iosLeaveAnimation, mdLeaveAnimation);
  }
  /**
   * Returns a promise that resolves when the alert did dismiss.
   */
  onDidDismiss() {
    return (0,_overlays_58fa8e4d_js__WEBPACK_IMPORTED_MODULE_4__.g)(this.el, 'ionAlertDidDismiss');
  }
  /**
   * Returns a promise that resolves when the alert will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_58fa8e4d_js__WEBPACK_IMPORTED_MODULE_4__.g)(this.el, 'ionAlertWillDismiss');
  }
  rbClick(selectedInput) {
    ...
    (0,_overlays_58fa8e4d_js__WEBPACK_IMPORTED_MODULE_4__.s)(selectedInput.handler, selectedInput);
  ...
  callButtonHandler(button, data) {
    return (0,_Users_lukas_Projects_bextrack_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (button === null || button === void 0 ? void 0 : button.handler) {
        ...
        const returnData = yield (0,_overlays_58fa8e4d_js__WEBPACK_IMPORTED_MODULE_4__.s)(button.handler, data);
        if (returnData === false) {
  ...
  render() {
    ...
    return (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_8e692445_js__WEBPACK_IMPORTED_MODULE_1__.H, Object.assign({
      ...
      id: msgId,
      class: "alert-message",
      innerHTML: (0,_index_6661fe90_js__WEBPACK_IMPORTED_MODULE_5__.s)(message)
