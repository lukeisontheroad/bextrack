...
/* harmony import */ var _index_6661fe90_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index-6661fe90.js */ 71128);
...
const Toast = class {
  ...
  present() {
    ...
    return (0,_Users_lukas_Projects_bextrack_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      yield (0,_overlays_58fa8e4d_js__WEBPACK_IMPORTED_MODULE_4__.d)(_this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, _this.position);
      if (_this.duration > 0) {
  ...
  dismiss(data, role) {
    ...
    return (0,_overlays_58fa8e4d_js__WEBPACK_IMPORTED_MODULE_4__.f)(this, data, role, 'toastLeave', iosLeaveAnimation, mdLeaveAnimation, this.position);
  }
  /**
   * Returns a promise that resolves when the toast did dismiss.
   */
  onDidDismiss() {
    return (0,_overlays_58fa8e4d_js__WEBPACK_IMPORTED_MODULE_4__.g)(this.el, 'ionToastDidDismiss');
  }
  /**
   * Returns a promise that resolves when the toast will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_58fa8e4d_js__WEBPACK_IMPORTED_MODULE_4__.g)(this.el, 'ionToastWillDismiss');
  }
  getButtons() {
  ...
  render() {
    ...
    if (layout === 'stacked' && startButtons.length > 0 && endButtons.length > 0) {
      (0,_index_c4b11676_js__WEBPACK_IMPORTED_MODULE_3__.p)('This toast is using start and end buttons with the stacked toast layout. We recommend following the best practice of using either start or end buttons with the stacked toast layout.', el);
    }
    return (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_8e692445_js__WEBPACK_IMPORTED_MODULE_1__.H, Object.assign({
      ...
      class: "toast-message",
      part: "message",
      innerHTML: (0,_index_6661fe90_js__WEBPACK_IMPORTED_MODULE_5__.s)(this.message)
...
const openURL = /*#__PURE__*/function () {
  var _ref = (0,_Users_lukas_Projects_bextrack_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url, ev, direction, animation) {
