...
/* harmony import */ var _overlays_58fa8e4d_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./overlays-58fa8e4d.js */ 6605);
/* harmony import */ var _index_6661fe90_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./index-6661fe90.js */ 71128);
...
const Loading = class {
  constructor(hostRef) {
    ...
    this.animated = true;
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_58fa8e4d_js__WEBPACK_IMPORTED_MODULE_3__.B);
    };
  }
  connectedCallback() {
    (0,_overlays_58fa8e4d_js__WEBPACK_IMPORTED_MODULE_3__.e)(this.el);
  }
  componentWillLoad() {
  ...
  present() {
    ...
    return (0,_Users_lukas_Projects_bextrack_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      yield (0,_overlays_58fa8e4d_js__WEBPACK_IMPORTED_MODULE_3__.d)(_this, 'loadingEnter', iosEnterAnimation, mdEnterAnimation);
      if (_this.duration > 0) {
  ...
  dismiss(data, role) {
    ...
    return (0,_overlays_58fa8e4d_js__WEBPACK_IMPORTED_MODULE_3__.f)(this, data, role, 'loadingLeave', iosLeaveAnimation, mdLeaveAnimation);
  }
  /**
   * Returns a promise that resolves when the loading did dismiss.
   */
  onDidDismiss() {
    return (0,_overlays_58fa8e4d_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el, 'ionLoadingDidDismiss');
  }
  /**
   * Returns a promise that resolves when the loading will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_58fa8e4d_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el, 'ionLoadingWillDismiss');
  }
  render() {
    const {
      message,
    ...
    return (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_8e692445_js__WEBPACK_IMPORTED_MODULE_1__.H, Object.assign({
      ...
      id: msgId,
      innerHTML: (0,_index_6661fe90_js__WEBPACK_IMPORTED_MODULE_4__.s)(message)
    })), (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      tabindex: "0"
    }));
  }
