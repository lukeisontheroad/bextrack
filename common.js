...
/***/ 2605:
/*!*************************************!*\
  !*** ./src/app/models/set_queue.ts ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SetQueue": () => (/* binding */ SetQueue)
/* harmony export */ });
class SetQueue {
  ...
  static deserialize(data) {
    ...
    parsedData.items.forEach(item => queue.enqueue(item));
    return queue;
  }
  toList() {
...
class StorageService {
  ...
  init() {
    ...
    return (0,_workspaces_bextrack_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (!_this.isInit) {
        _this.prefix = (yield _this.apiService.getUser()).id + _this.prefix;
        _this.isInit = true;
      }
    })();
  }
  removeItem(key) {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref = (0,_workspaces_bextrack_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve, reject) {
        yield _this2.init();
        localStorage.removeItem(_this2.prefix + key);
        resolve();
      });
  ...
  setItem(key, value) {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref2 = (0,_workspaces_bextrack_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve, reject) {
        yield _this3.init();
        localStorage.setItem(_this3.prefix + key, value);
        resolve();
      });
  ...
  getString(key, def = null) {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref3 = (0,_workspaces_bextrack_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve, reject) {
        yield _this4.init();
        let loaded = yield localStorage.getItem(_this4.prefix + key);
  ...
  getDate(key, def = null) {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref4 = (0,_workspaces_bextrack_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve, reject) {
        yield _this5.init();
        let loaded = yield _this5.getString(key);
        if (loaded == null) {
          resolve(def);
        } else {
  ...
  getNumber(key, def = null) {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref5 = (0,_workspaces_bextrack_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve, reject) {
        yield _this6.init();
        let loaded = yield _this6.getString(key);
        if (def != null && loaded == null) {
          resolve(def);
        } else {
  ...
  getBoolean(key, def = null) {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref6 = (0,_workspaces_bextrack_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve, reject) {
        yield _this7.init();
        let loaded = yield _this7.getString(key);
        if (def != null && loaded == null) {
          resolve(def);
        } else {
          resolve(loaded === 'true');
...
StorageService.ɵfac = function StorageService_Factory(t) {
  return new (t || StorageService)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_api_api_service__WEBPACK_IMPORTED_MODULE_1__.ApiService));
};
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,_workspaces_bextrack_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
    if (delegate) {
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,_workspaces_bextrack_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_workspaces_bextrack_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
