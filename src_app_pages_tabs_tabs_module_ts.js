...
const routes = [{
  ...
  children: [{
    ...
    children: [{
      path: '',
      loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_models_stopwatch_ts-src_app_pipes_pipes_module_ts-src_app_services_stopwatche-fddc23"), __webpack_require__.e("default-src_app_components_components_module_ts"), __webpack_require__.e("common"), __webpack_require__.e("src_app_pages_times_times_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ../times/times.module */ 4690)).then(m => m.TimesPageModule)
    }]
  }, {
    path: 'contacts',
    children: [{
      path: '',
      loadChildren: () => __webpack_require__.e(/*! import() */ "default-src_app_pages_contacts_contacts_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../contacts/contacts.module */ 50464)).then(m => m.ContactsPageModule)
    }]
  }, {
    path: 'stopwatches',
    children: [{
